...
Otherwise: Milestone 8 — remaining pieces (speakers section on `/` linking to `/speakers`, then the schedule page once the `schedule` collection is populated), or Milestone 9 — Polish & launch.
