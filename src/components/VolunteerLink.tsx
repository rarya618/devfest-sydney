...
interface VolunteerLinkProps extends Omit<AnchorHTMLAttributes<HTMLAnchorElement>, 'href'> {
  children: ReactNode;
...
// persists UTM params to localStorage on landing, and VolunteerForm reads them from
...
export default function VolunteerLink({ children, source, ...rest }: VolunteerLinkProps) {
  const href = source
    ? `/volunteer?${new URLSearchParams({
