            ...
            {ticketsOnSale ? (
              <>
                ...
                <TicketsLink
                  ...
                  className="inline-flex items-center gap-2.5 px-7 py-2 bg-google-blue-deep text-white text-base font-bold rounded border border-google-blue-deep transition-opacity hover:opacity-80 animate-slide-up"
