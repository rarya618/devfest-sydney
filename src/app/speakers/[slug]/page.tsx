        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-8">
            ...
            <div className="min-w-0">
              <p
                className={`inline-flex items-center gap-2 font-mono text-[11px] uppercase tracking-[0.15em] mb-3 animate-slide-up ${TRACK_COLORS[speaker.track]}`}
          ...
          <div className="space-y-8">
            <Reveal>
              <article className="rounded-xl border-l-[8px] border-google-red bg-white/[0.035] p-8 md:p-10">
                <p className="font-mono text-[11px] uppercase tracking-[0.15em] text-white/55 mb-3">{FORMAT_LABELS[speaker.format]}</p>
